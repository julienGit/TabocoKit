...
#import "TBCMarqueeLabel.h"

@interface TBCMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
@implementation TBCMarqueeLabel
...
-(void)commonInit{
    self.marqueeLabelType = TBCMarqueeLabelTypeLeftRight;
...
-(void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == TBCMarqueeLabelTypeLeft) {
