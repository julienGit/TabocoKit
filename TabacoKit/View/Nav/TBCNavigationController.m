...
#import "UIViewController+TBC.h"
#import "TBCNavigationBar.h"
...
@interface TBCNavigationControllerDelegate : UIScreenEdgePanGestureRecognizer <UINavigationControllerDelegate, UIGestureRecognizerDelegate>

@property (nonatomic, weak) id<UINavigationControllerDelegate> proxiedDelegate;
@property (nonatomic, weak, readonly) TBCNavigationController *nav;

- (instancetype)initWithNavigationController:(TBCNavigationController *)navigationController;

@end

@interface TBCNavigationController ()


@property (nonatomic, readonly) TBCNavigationBar *navigationBar;
...
@property (nonatomic, strong) TBCNavigationControllerDelegate *navigationDelegate;
...
@implementation TBCNavigationControllerDelegate

- (instancetype)initWithNavigationController:(TBCNavigationController *)nav {
    if (self = [super init]) {
        _nav = nav;
...
- (void)handleNavigationTransition:(UIScreenEdgePanGestureRecognizer *)pan {
    TBCNavigationController *nav = self.nav;
    if (![self.proxiedDelegate respondsToSelector:@selector(navigationController:interactionControllerForAnimationController:)]) {
        id<TBCNavigationTransitionProtocol> target = (id<TBCNavigationTransitionProtocol>)[nav superInteractivePopGestureRecognizer].delegate;
...
@implementation TBCNavigationController

@dynamic navigationBar;

- (instancetype)initWithRootViewController:(UIViewController *)rootViewController {
    if (self = [super initWithNavigationBarClass:[TBCNavigationBar class] toolbarClass:nil]) {
...
- (instancetype)initWithNavigationBarClass:(Class)navigationBarClass toolbarClass:(Class)toolbarClass {
    NSAssert([navigationBarClass isSubclassOfClass:[TBCNavigationBar class]], @"navigationBarClass Must be a subclass of HBDNavigationBar");
    return [super initWithNavigationBarClass:navigationBarClass toolbarClass:toolbarClass];
}

- (instancetype)init {
    return [super initWithNavigationBarClass:[TBCNavigationBar class] toolbarClass:nil];
}

- (void)setDelegate:(id<UINavigationControllerDelegate>)delegate {
    if ([delegate isKindOfClass:[TBCNavigationControllerDelegate class]] || !self.navigationDelegate) {
...
- (void)viewDidLoad {
    ...
    self.navigationDelegate = [[TBCNavigationControllerDelegate alloc] initWithNavigationController:self];
